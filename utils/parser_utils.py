...
def add_base_options(parser):
    ...
    # group.add_argument("--cuda", default=False, type=bool, help="Use cuda device, otherwise use CPU.")
...
def add_model_options(parser):
    ...
    group.add_argument("--lambda_pos", default=0.6, type=float, help="Joint positions loss.")
    group.add_argument("--lambda_vel", default=0.2, type=float, help="Joint velocity loss.")
    group.add_argument("--lambda_fc", default=0.2, type=float, help="Foot contact loss.")


def add_data_options(parser):
    group = parser.add_argument_group('dataset')
    # group.add_argument("--dataset", default='humanact12', choices=['humanml', 'kit', 'humanact12', 'uestc'], type=str,
...
def add_training_options(parser):
    ...
    group.add_argument("--save_dir", default='./save/trial1', type=str,
    ...
    group.add_argument("--lr", default=1e-9, type=float, help="Learning rate.")
